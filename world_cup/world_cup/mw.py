    ...
    def process_request(self, request: HttpRequest) -> HttpResponse | None:
        ...
        if request._cors_enabled:
            ...
            if (
                ...
                print('OOOOUT----------------->>>>', response)
                print('OOOOUT1---------------->>>>', response.headers)
                return response
        print('request._cors_enabled:', request._cors_enabled)
